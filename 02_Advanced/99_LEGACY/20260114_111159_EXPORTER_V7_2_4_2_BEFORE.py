...
# Importiamo la policy v7
from liventre_policy_bridge_v7 import classify_json_dict  # noqa: F401


# ================================
# Directory di input e output
# ================================
JSON_DIR = pathlib.Path("./JSON_IO/LMetrics_v7")     # sorgente JSON v7
COQ_OUT_DIR = pathlib.Path("./Coq_IO/LMetrics_v7_export")  # destinazione .v Coq
...
def emit_coq_snippet(name: str, d: Dict[str, Any]) -> str:
    # Qui assumiamo campi int nella base minima
    ctor = (
        f"Build_LMetricsV7"
...
def export_one_json(path: pathlib.Path) -> pathlib.Path:
    ...
    base = path.stem  # nome file senza .json
