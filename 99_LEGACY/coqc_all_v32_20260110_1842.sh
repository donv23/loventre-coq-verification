...
#     - Loventre_Global_Invariant_Stub depends on:
#         Loventre_LMetrics_Structure
#         Loventre_LMetrics_Robustness
#     - Dynamic_Perturbation_Identity depends on:
#         Loventre_Global_Invariant_Stub
# -------------------------------------------------------------------
...
# -------------------------------------------------------------------
# (B) Complexity/Noise/Class chain
#   OBSERVED DEPENDENCIES:
#     - Loventre_Complexity_Noise_Stability depends on Loventre_Noise_Regimes
# -------------------------------------------------------------------
