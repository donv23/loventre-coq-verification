...
*)
Inductive noise_precedes :
  Loventre_Noise_Regimes.Noise_Regime ->
  Loventre_Noise_Regimes.Noise_Regime ->
  Prop :=
...
Lemma noise_precedes_irreflexive :
  forall r : Loventre_Noise_Regimes.Noise_Regime,
    ~ noise_precedes r r.
Proof.
  intros r H.
  inversion H.
...
Lemma noise_precedes_transitive :
  forall r1 r2 r3 : Loventre_Noise_Regimes.Noise_Regime,
