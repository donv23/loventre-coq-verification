...
"""
loventre_lab_export_v12.py
------------------------------------
Esporta 3 snapshot LAB V12 in JSON *solo sandbox*:

  • SAFE_ACCESSIBLE
  • SAFE
  • BLACKHOLE

Nessun effetto su JSON canonici.
"""

import json
import os
from loventre_lab_entrypoint_v12 import run_lab_entrypoint_v12
...
def run_lab_export_v12():
    ...
    for fname, kappa, entropy in cases:
        snapshot = run_lab_entrypoint_v12(kappa_eff=kappa,
                                          entropy_eff=entropy)
