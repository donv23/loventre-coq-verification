#!/bin/zsh
# ------------------------------------------------------------
# Fix150.15 — Compilazione LMetrics_v6 + witness minimale
# Canvas v1150.150.15
# ------------------------------------------------------------
...
# Crea witness minimale con namespace corretto
...
# Compila il witness usando -R per il namespace già registrato
