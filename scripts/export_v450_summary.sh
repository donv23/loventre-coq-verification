...
(* Nel modello Loventre: semplice identity con “zero penalty”              *)
(* In futuro: inserire curvatura/entropia graduata                          *)
(***************************************************************************)
...
(* Il mapping non “migliora” nulla, ma preserva le proprietà buone         *)
(***************************************************************************)
