...
content = r'''(* Loventre_LMetrics_Separation_Theorem
...
Path("03_Main/Loventre_LMetrics_Separation_Theorem.v").write_text(content, encoding="utf-8")
print("Wrote 03_Main/Loventre_LMetrics_Separation_Theorem.v")
